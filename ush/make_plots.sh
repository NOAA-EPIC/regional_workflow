...
############
ncar_pylib /contrib/GST/ncar_pylib/python_graphics

############
# Path to shape files
############
#Cheyenne:
SHAPE_FILES=/contrib/GST/NaturalEarth
...
python plot_allvars.py ${CDATE} ${FCST_START} ${FCST_END} ${FCST_INC} ${EXPTDIR} ${SHAPE_FILES} ${POST_OUTPUT_DOMAIN_NAME}
